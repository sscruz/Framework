...
if __name__ == '__main__':
    ...
    DATAnumeratorMlleevalue =     treeDA.getTH1F(lumi, "DATAnumeratoreevalue", "lepsMll_Edge", [20, 1000], 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labelx)
    ...
    DATAnumeratorMllmmvalue =     treeDA.getTH1F(lumi, "DATAnumeratormmvalue", "lepsMll_Edge", [20, 1000], 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labelx)
    ...
    DATAnumeratorMllSFvalue =     treeDA.getTH1F(lumi, "DATAnumeratorSFvalue", "lepsMll_Edge", [20, 1000], 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labelx)
    ...
    DATAnumeratorMllOFvalue =     treeDA.getTH1F(lumi, "DATAnumeratorOFvalue", "lepsMll_Edge", [20, 1000], 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labelx)
    ...
    MCnumeratorMlleevalue =     treeMC.getTH1F(lumi, "MCnumeratoreevalue", "lepsMll_Edge", [20, 1000], 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labelx)
    ...
    MCnumeratorMllmmvalue =     treeMC.getTH1F(lumi, "MCnumeratormmvalue", "lepsMll_Edge", [20, 1000], 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labelx)
    ...
    MCnumeratorMllSFvalue =     treeMC.getTH1F(lumi, "MCnumeratorSFvalue", "lepsMll_Edge", [20, 1000], 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labelx)
    ...
    MCnumeratorMllOFvalue =     treeMC.getTH1F(lumi, "MCnumeratorOFvalue", "lepsMll_Edge", [20, 1000], 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labelx)
    ...
    print "MCnumeratorMlleevalue ", MCnumeratorMlleevalue
    print "MCdenominatorMlleevalue ", MCdenominatorMlleevalue
    print "MCnumeratorMllmmvalue ", MCnumeratorMllmmvalue
    print "MCdenominatorMllmmvalue ", MCdenominatorMllmmvalue
    print "MCnumeratorMllSFvalue ", MCnumeratorMllSFvalue
    print "MCdenominatorMllSFvalue ", MCdenominatorMllSFvalue
    print "MCnumeratorMllOFvalue ", MCnumeratorMllOFvalue
    print "MCdenominatorMllOFvalue ", MCdenominatorMllOFvalue
    ...
    if makeDependencyPlots: 
        ...
        DATAnumeratorMllee =   treeDA.getTH1F(lumi, "DATAnumeratoree", "lepsMll_Edge", mllbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labelx)
        ...
        DATAnumeratorMllmm =   treeDA.getTH1F(lumi, "DATAnumeratormm", "lepsMll_Edge", mllbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labelx)
        ...
        DATAnumeratorMllSF =   treeDA.getTH1F(lumi, "DATAnumeratorSF", "lepsMll_Edge", mllbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labelx)
        ...
        DATAnumeratorMllOF =   treeDA.getTH1F(lumi, "DATAnumeratorOF", "lepsMll_Edge", mllbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labelx)
        ...
        DATAnumeratorpt1ee =   treeDA.getTH1F(lumi, "DATAnumeratorpt1ee", "Lep1_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labelpt1)
        ...
        DATAnumeratorpt1mm =   treeDA.getTH1F(lumi, "DATAnumeratorpt1mm", "Lep1_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labelpt1)
        ...
        DATAnumeratorpt1SF =   treeDA.getTH1F(lumi, "DATAnumeratorpt1SF", "Lep1_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labelpt1)
        ...
        DATAnumeratorpt1OF =   treeDA.getTH1F(lumi, "DATAnumeratorpt1OF", "Lep1_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labelpt1)
        ...
        DATAnumeratorpt2ee =   treeDA.getTH1F(lumi, "DATAnumeratorpt2ee", "Lep2_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labelpt2)
        ...
        DATAnumeratorpt2mm =   treeDA.getTH1F(lumi, "DATAnumeratorpt2mm", "Lep2_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labelpt2)
        ...
        DATAnumeratorpt2SF =   treeDA.getTH1F(lumi, "DATAnumeratorpt2SF", "Lep2_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labelpt2)
        ...
        DATAnumeratorpt2OF =   treeDA.getTH1F(lumi, "DATAnumeratorpt2OF", "Lep2_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labelpt2)
        ...
        DATAnumeratoreta1ee =   treeDA.getTH1F(lumi, "DATAnumeratoreta1ee", "Lep1_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labeleta1)
        ...
        DATAnumeratoreta1mm =   treeDA.getTH1F(lumi, "DATAnumeratoreta1mm", "Lep1_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labeleta1)
        ...
        DATAnumeratoreta1SF =   treeDA.getTH1F(lumi, "DATAnumeratoreta1SF", "Lep1_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labeleta1)
        ...
        DATAnumeratoreta1OF =   treeDA.getTH1F(lumi, "DATAnumeratoreta1OF", "Lep1_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labeleta1)
        ...
        DATAnumeratoreta2ee =   treeDA.getTH1F(lumi, "DATAnumeratoreta2ee", "Lep2_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labeleta2)
        ...
        DATAnumeratoreta2mm =   treeDA.getTH1F(lumi, "DATAnumeratoreta2mm", "Lep2_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labeleta2)
        ...
        DATAnumeratoreta2SF =   treeDA.getTH1F(lumi, "DATAnumeratoreta2SF", "Lep2_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labeleta2)
        ...
        DATAnumeratoreta2OF =   treeDA.getTH1F(lumi, "DATAnumeratoreta2OF", "Lep2_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labeleta2)
        ...
        DATAnumeratorMETee =     treeDA.getTH1F(lumi, "DATAnumeratoreevalue", "met_Edge", metbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labelmet)
        ...
        DATAnumeratorMETmm =     treeDA.getTH1F(lumi, "DATAnumeratormmvalue", "met_Edge", metbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labelmet)
        ...
        DATAnumeratorMETSF =     treeDA.getTH1F(lumi, "DATAnumeratorSFvalue", "met_Edge", metbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labelmet)
        ...
        DATAnumeratorMETOF =     treeDA.getTH1F(lumi, "DATAnumeratorOFvalue", "met_Edge", metbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labelmet)
        ...
        DATAnumeratormt2ee =     treeDA.getTH1F(lumi, "DATAnumeratoreevalue", "mt2_Edge", mt2bins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labelmt2)
        ...
        DATAnumeratormt2mm =     treeDA.getTH1F(lumi, "DATAnumeratormmvalue", "mt2_Edge", mt2bins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labelmt2)
        ...
        DATAnumeratormt2SF =     treeDA.getTH1F(lumi, "DATAnumeratorSFvalue", "mt2_Edge", mt2bins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labelmt2)
        ...
        DATAnumeratormt2OF =     treeDA.getTH1F(lumi, "DATAnumeratorOFvalue", "mt2_Edge", mt2bins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labelmt2)            
        ...
        MCnumeratorMllee =   treeMC.getTH1F(lumi, "MCnumeratoree", "lepsMll_Edge", mllbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labelx)
        ...
        MCnumeratorMllmm =   treeMC.getTH1F(lumi, "MCnumeratormm", "lepsMll_Edge", mllbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labelx)
        ...
        MCnumeratorMllSF =   treeMC.getTH1F(lumi, "MCnumeratorSF", "lepsMll_Edge", mllbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labelx)
        ...
        MCnumeratorMllOF =   treeMC.getTH1F(lumi, "MCnumeratorOF", "lepsMll_Edge", mllbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labelx)
        ...
        MCnumeratorpt1ee =   treeMC.getTH1F(lumi, "MCnumeratorpt1ee", "Lep1_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labelpt1)
        ...
        MCnumeratorpt1mm =   treeMC.getTH1F(lumi, "MCnumeratorpt1mm", "Lep1_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labelpt1)
        ...
        MCnumeratorpt1SF =   treeMC.getTH1F(lumi, "MCnumeratorpt1SF", "Lep1_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labelpt1)
        ...
        MCnumeratorpt1OF =   treeMC.getTH1F(lumi, "MCnumeratorpt1OF", "Lep1_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labelpt1)
        ...
        MCnumeratorpt2ee =   treeMC.getTH1F(lumi, "MCnumeratorpt2ee", "Lep2_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labelpt2)
        ...
        MCnumeratorpt2mm =   treeMC.getTH1F(lumi, "MCnumeratorpt2mm", "Lep2_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labelpt2)
        ...
        MCnumeratorpt2SF =   treeMC.getTH1F(lumi, "MCnumeratorpt2SF", "Lep2_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labelpt2)
        ...
        MCnumeratorpt2OF =   treeMC.getTH1F(lumi, "MCnumeratorpt2OF", "Lep2_pt_Edge", ptbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labelpt2)
        ...
        MCnumeratoreta1ee =   treeMC.getTH1F(lumi, "MCnumeratoreta1ee", "Lep1_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labeleta1)
        ...
        MCnumeratoreta1mm =   treeMC.getTH1F(lumi, "MCnumeratoreta1mm", "Lep1_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labeleta1)
        ...
        MCnumeratoreta1SF =   treeMC.getTH1F(lumi, "MCnumeratoreta1SF", "Lep1_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labeleta1)
        ...
        MCnumeratoreta1OF =   treeMC.getTH1F(lumi, "MCnumeratoreta1OF", "Lep1_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labeleta1)
        ...
        MCnumeratoreta2ee =   treeMC.getTH1F(lumi, "MCnumeratoreta2ee", "Lep2_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labeleta2)
        ...
        MCnumeratoreta2mm =   treeMC.getTH1F(lumi, "MCnumeratoreta2mm", "Lep2_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labeleta2)
        ...
        MCnumeratoreta2SF =   treeMC.getTH1F(lumi, "MCnumeratoreta2SF", "Lep2_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labeleta2)
        ...
        MCnumeratoreta2OF =   treeMC.getTH1F(lumi, "MCnumeratoreta2OF", "Lep2_eta_Edge", etabins, 1, 1,cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labeleta2)
        ...
        MCnumeratorMETee =     treeMC.getTH1F(lumi, "MCnumeratoreevalue", "met_Edge", metbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labelmet)
        ...
        MCnumeratorMETmm =     treeMC.getTH1F(lumi, "MCnumeratormmvalue", "met_Edge", metbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labelmet)
        ...
        MCnumeratorMETSF =     treeMC.getTH1F(lumi, "MCnumeratorSFvalue", "met_Edge", metbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labelmet)
        ...
        MCnumeratorMETOF =     treeMC.getTH1F(lumi, "MCnumeratorOFvalue", "met_Edge", metbins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labelmet)
        ...
        MCnumeratormt2ee =     treeMC.getTH1F(lumi, "MCnumeratoreevalue", "mt2_Edge", mt2bins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.ee]), '', labelmt2)
        ...
        MCnumeratormt2mm =     treeMC.getTH1F(lumi, "MCnumeratormmvalue", "mt2_Edge", mt2bins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.mm]), '', labelmt2)
        ...
        MCnumeratormt2SF =     treeMC.getTH1F(lumi, "MCnumeratorSFvalue", "mt2_Edge", mt2bins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.SF]), '', labelmt2)
        ...
        MCnumeratormt2OF =     treeMC.getTH1F(lumi, "MCnumeratorOFvalue", "mt2_Edge", mt2bins, 1, 1, cuts.AddList([specialcut, cuts.numerator,  cuts.OF]), '', labelmt2)                
