...
if __name__ == '__main__':
    ...
    effRTMll.addLatex (0.6, 0.25, 'Mean R_{T} data: %.3f '%(dart))
    effRTMll.addLatex (0.6, 0.2, 'Mean R_{T} MC: %.3f '%(mcrt))
    ...
    effRTeta2.addBand(h_auxrteta2.GetXaxis().GetXmin(), dart-systrt, h_auxrteta2.GetXaxis().GetXmax(), dart+systrt, r.kOrange+6, 0.2)
    ...
    effMll.addHisto(effMlleeDATA, 'PE,SAME', 'Double Electron', 'PL', r.kRed+1 , 1, 0)
    effMll.addHisto(effMllmmDATA, 'PE,SAME', 'Double Muon', 'PL', r.kBlue+1 , 1, 0)
    effMll.addHisto(effMllSFDATA, 'PE,SAME', 'Same Flavor', 'PL', r.kGreen+1 , 1, 0)
    effMll.addHisto(effMllOFDATA, 'PE,SAME', 'Opposite Flavor', 'PL', r.kBlack+1 , 1, 0)
    ...
    effmt2.addHisto(effmt2eeDATA, 'PE,SAME', 'Double Electron', 'PL', r.kRed+1 , 1, 0)
    effmt2.addHisto(effmt2mmDATA, 'PE,SAME', 'Double Muon', 'PL', r.kBlue+1 , 1, 0)
    effmt2.addHisto(effmt2SFDATA, 'PE,SAME', 'Same Flavor', 'PL', r.kGreen+1 , 1, 0)
    effmt2.addHisto(effmt2OFDATA, 'PE,SAME', 'Opposite Flavor', 'PL', r.kBlack+1 , 1, 0)
    ...
    effpt1.addHisto(effpt1eeDATA, 'PE,SAME', 'Double Electron', 'PL', r.kRed+1 , 1, 0)
    effpt1.addHisto(effpt1mmDATA, 'PE,SAME', 'Double Muon', 'PL', r.kBlue+1 , 1, 0)
    effpt1.addHisto(effpt1SFDATA, 'PE,SAME', 'Same Flavor', 'PL', r.kGreen+1 , 1, 0)
    effpt1.addHisto(effpt1OFDATA, 'PE,SAME', 'Opposite Flavor', 'PL', r.kBlack+1 , 1, 0)
    ...
    effpt2.addHisto(effpt2eeDATA, 'PE,SAME', 'Double Electron', 'PL', r.kRed+1 , 1, 0)
    effpt2.addHisto(effpt2mmDATA, 'PE,SAME', 'Double Muon', 'PL', r.kBlue+1 , 1, 0)
    effpt2.addHisto(effpt2SFDATA, 'PE,SAME', 'Same Flavor', 'PL', r.kGreen+1 , 1, 0)
    effpt2.addHisto(effpt2OFDATA, 'PE,SAME', 'Opposite Flavor', 'PL', r.kBlack+1 , 1, 0)
    ...
    effeta1.addHisto(effeta1eeDATA, 'PE,SAME', 'Double Electron', 'PL', r.kRed+1 , 1, 0)
    effeta1.addHisto(effeta1mmDATA, 'PE,SAME', 'Double Muon', 'PL', r.kBlue+1 , 1, 0)
    effeta1.addHisto(effeta1SFDATA, 'PE,SAME', 'Same Flavor', 'PL', r.kGreen+1 , 1, 0)
    effeta1.addHisto(effeta1OFDATA, 'PE,SAME', 'Opposite Flavor', 'PL', r.kBlack+1 , 1, 0)
    ...
    effeta2.addHisto(effeta2eeDATA, 'PE,SAME', 'Double Electron', 'PL', r.kRed+1 , 1, 0)
    effeta2.addHisto(effeta2mmDATA, 'PE,SAME', 'Double Muon', 'PL', r.kBlue+1 , 1, 0)
    effeta2.addHisto(effeta2SFDATA, 'PE,SAME', 'Same Flavor', 'PL', r.kGreen+1 , 1, 0)
    effeta2.addHisto(effeta2OFDATA, 'PE,SAME', 'Opposite Flavor', 'PL', r.kBlack+1 , 1, 0)
