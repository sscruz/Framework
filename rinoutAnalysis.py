...
def runAnalysis(lumi, treeDA, treeMC, cuts, specialcut, tag, save, ingredientsFile):
    ...
    if makeNicePlot:
       #make the nice finely binned plots for the presentation
        mll_SF_inclusive_mc = treeMC.getTH1F(lumi,"MC_imll_SF","lepsMll_Edge",inclusivebins,1,1,cuts.AddList([cuts.mT2_80, cuts.goodLepton, cuts.SF, cuts.DYControlRegionNoMll]),'', labelx, "1", kf)
        mll_OF_inclusive_mc = treeMC.getTH1F(lumi,"MC_imll_OF","lepsMll_Edge",inclusivebins,1,1,cuts.AddList([cuts.mT2_80, cuts.goodLepton, cuts.OF, cuts.DYControlRegionNoMll]),'', labelx, "1", kf)
        mll_SF_inclusive_da = treeDA.getTH1F(lumi,"DA_imll_SF","lepsMll_Edge",inclusivebins,1,1,cuts.AddList([cuts.mT2_80, cuts.goodLepton, cuts.SF, cuts.DYControlRegionNoMll]),'', labelx, "1", kf)
        mll_OF_inclusive_da = treeDA.getTH1F(lumi,"DA_imll_OF","lepsMll_Edge",inclusivebins,1,1,cuts.AddList([cuts.mT2_80, cuts.goodLepton, cuts.OF, cuts.DYControlRegionNoMll]),'', labelx, "1", kf)
    ...
    mll_SF_coarse_mc = treeMC.getTH1F(lumi, "MC_inclusive_mll_SF", "lepsMll_Edge", coarsebins, 1, 1, cuts.AddList([cuts.mT2_80, cuts.SF, cuts.DYControlRegionNoMll]), '', labelx, "1", kf)
    mll_OF_coarse_mc = treeMC.getTH1F(lumi, "MC_inclusive_mll_OF", "lepsMll_Edge", coarsebins, 1, 1, cuts.AddList([cuts.mT2_80, cuts.OF, cuts.DYControlRegionNoMll]), '', labelx, "1", kf)
    mll_SF_coarse_da = treeDA.getTH1F(lumi, "DA_inclusive_mll_SF", "lepsMll_Edge", coarsebins, 1, 1, cuts.AddList([cuts.mT2_80, cuts.SF, cuts.DYControlRegionNoMll]), '', labelx, "1", kf)
    mll_OF_coarse_da = treeDA.getTH1F(lumi, "DA_inclusive_mll_OF", "lepsMll_Edge", coarsebins, 1, 1, cuts.AddList([cuts.mT2_80, cuts.OF, cuts.DYControlRegionNoMll]), '', labelx, "1", kf)
    ...
    met_1_SF_mc= treeMC.getTH1F(lumi,"MC_20-60SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll20_60]),'', labelmet, "1", kf)
    met_1_SF_da= treeDA.getTH1F(lumi,"DA_20-60SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll20_60]),'', labelmet, "1", kf)
    met_1_OF_mc= treeMC.getTH1F(lumi,"MC_20-60OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll20_60]),'', labelmet, "1", kf)
    met_1_OF_da= treeDA.getTH1F(lumi,"DA_20-60OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll20_60]),'', labelmet, "1", kf)
    met_2_SF_mc= treeMC.getTH1F(lumi,"MC_60-86SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll60_86]),'', labelmet, "1", kf)
    met_2_SF_da= treeDA.getTH1F(lumi,"DA_60-86SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll60_86]),'', labelmet, "1", kf)
    met_2_OF_mc= treeMC.getTH1F(lumi,"MC_60-86OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll60_86]),'', labelmet, "1", kf)
    met_2_OF_da= treeDA.getTH1F(lumi,"DA_60-86OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll60_86]),'', labelmet, "1", kf)
    met_z_SF_mc= treeMC.getTH1F(lumi,"MC_86-96SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll86_96]),'', labelmet, "1", kf)
    met_z_SF_da= treeDA.getTH1F(lumi,"DA_86-96SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll86_96]),'', labelmet, "1", kf)
    met_z_OF_mc= treeMC.getTH1F(lumi,"MC_86-96OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll86_96]),'', labelmet, "1", kf)
    met_z_OF_da= treeDA.getTH1F(lumi,"DA_86-96OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll86_96]),'', labelmet, "1", kf)
    met_3_SF_mc= treeMC.getTH1F(lumi,"MC_96-150SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll96_150]),'', labelmet, "1", kf)
    met_3_SF_da= treeDA.getTH1F(lumi,"DA_96-150SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll96_150]),'', labelmet, "1", kf)
    met_3_OF_mc= treeMC.getTH1F(lumi,"MC_96-150OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll96_150]),'', labelmet, "1", kf)
    met_3_OF_da= treeDA.getTH1F(lumi,"DA_96-150OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll96_150]),'', labelmet, "1", kf)
    met_4_SF_mc= treeMC.getTH1F(lumi,"MC_150-200SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll150_200]),'', labelmet, "1", kf)
    met_4_SF_da= treeDA.getTH1F(lumi,"DA_150-200SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll150_200]),'',labelmet, "1", kf)
    met_4_OF_mc= treeMC.getTH1F(lumi,"MC_150-200OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll150_200]),'', labelmet, "1", kf)
    met_4_OF_da= treeDA.getTH1F(lumi,"DA_150-200OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll150_200]),'',labelmet, "1", kf)
    met_5_SF_mc= treeMC.getTH1F(lumi,"MC_200-300SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll200_300]),'', labelmet, "1", kf)
    met_5_SF_da= treeDA.getTH1F(lumi,"DA_200-300SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll200_300]),'',labelmet, "1", kf)
    met_5_OF_mc= treeMC.getTH1F(lumi,"MC_200-300OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll200_300]),'', labelmet, "1", kf)
    met_5_OF_da= treeDA.getTH1F(lumi,"DA_200-300OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll200_300]),'',labelmet, "1", kf)
    met_6_SF_mc= treeMC.getTH1F(lumi,"MC_300-400SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll300_400]),'', labelmet, "1", kf)
    met_6_SF_da= treeDA.getTH1F(lumi,"DA_300-400SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll300_400]),'',labelmet, "1", kf)
    met_6_OF_mc= treeMC.getTH1F(lumi,"MC_300-400OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll300_400]),'', labelmet, "1", kf)
    met_6_OF_da= treeDA.getTH1F(lumi,"DA_300-400OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll300_400]),'',labelmet, "1", kf)
    met_7_SF_mc= treeMC.getTH1F(lumi,"MC_400_SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll400]),'', labelmet, "1", kf)
    met_7_SF_da= treeDA.getTH1F(lumi,"DA_400_SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll400]),'', labelmet, "1", kf)
    met_7_OF_mc= treeMC.getTH1F(lumi,"MC_400_OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll400]),'', labelmet, "1", kf)
    met_7_OF_da= treeDA.getTH1F(lumi,"DA_400_OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll400]),'', labelmet, "1", kf)
    ...
    met_rinout_20_60_mc = make_rinout_histo(met_1_corrected_mc, met_z_corrected_mc, 0., 0.4)
    met_rinout_20_60_da = make_rinout_histo(met_1_corrected_da, met_z_corrected_da, 0., 0.4 )  
    met_rinout_60_86_mc = make_rinout_histo(met_2_corrected_mc, met_z_corrected_mc, 0., 0.8 )
    met_rinout_60_86_da = make_rinout_histo(met_2_corrected_da, met_z_corrected_da, 0., 0.8 )  
    met_rinout_96_150_mc = make_rinout_histo(met_3_corrected_mc, met_z_corrected_mc, 0.,1.) 
    met_rinout_96_150_da = make_rinout_histo(met_3_corrected_da, met_z_corrected_da, 0., 1.)
    met_rinout_150_200_mc = make_rinout_histo(met_4_corrected_mc, met_z_corrected_mc, 0., 0.3)  
    met_rinout_150_200_da = make_rinout_histo(met_4_corrected_da, met_z_corrected_da, 0., 0.3)
    met_rinout_200_300_mc = make_rinout_histo(met_5_corrected_mc, met_z_corrected_mc, 0., 0.1) 
    met_rinout_200_300_da = make_rinout_histo(met_5_corrected_da, met_z_corrected_da, 0., 0.1)
    met_rinout_300_400_mc = make_rinout_histo(met_6_corrected_mc, met_z_corrected_mc, 0., 0.02) 
    met_rinout_300_400_da = make_rinout_histo(met_6_corrected_da, met_z_corrected_da, 0., 0.02)
    met_rinout_400_mc     = make_rinout_histo(met_7_corrected_mc, met_z_corrected_mc, 0., 0.02) 
    met_rinout_400_da     = make_rinout_histo(met_7_corrected_da, met_z_corrected_da, 0., 0.02) 
    ...
    plot_met_rinout_20_60.addBand(met_rinout_20_60_mc.GetXaxis().GetXmin(), rinout_20_60_da[0]*0.5, met_rinout_20_60_mc.GetXaxis().GetXmax(), rinout_20_60_da[0]*1.5, r.kOrange+6, 0.2)
    ...
    plot_met_rinout_60_86.addBand(met_rinout_60_86_mc.GetXaxis().GetXmin(), rinout_60_86_da[0]*0.5, met_rinout_60_86_mc.GetXaxis().GetXmax(), rinout_60_86_da[0]*1.5, r.kOrange+6, 0.2)         
    ...
    plot_met_rinout_96_150.addBand(met_rinout_96_150_mc.GetXaxis().GetXmin(), rinout_96_150_da[0]*0.5, met_rinout_96_150_mc.GetXaxis().GetXmax(), rinout_96_150_da[0]*1.5, r.kOrange+6, 0.2)
    ...
    plot_met_rinout_150_200.addBand(met_rinout_150_200_mc.GetXaxis().GetXmin(), rinout_150_200_da[0]*0.5, met_rinout_150_200_mc.GetXaxis().GetXmax(), rinout_150_200_da[0]*1.5, r.kOrange+6, 0.2)
    ...
    plot_met_rinout_200_300.addBand(met_rinout_200_300_mc.GetXaxis().GetXmin(), rinout_200_300_da[0]*0.5, met_rinout_200_300_mc.GetXaxis().GetXmax(), rinout_200_300_da[0]*1.5, r.kOrange+6, 0.2)
    ...
    plot_met_rinout_300_400.addBand(met_rinout_300_400_mc.GetXaxis().GetXmin(), rinout_300_400_da[0]*0.5, met_rinout_300_400_mc.GetXaxis().GetXmax(), rinout_300_400_da[0]*1.5, r.kOrange+6, 0.2)
    ...
    plot_met_rinout_400.addBand(met_rinout_400_mc.GetXaxis().GetXmin(), rinout_400_da[0]*0.5, met_rinout_400_mc.GetXaxis().GetXmax(), rinout_400_da[0]*1.5, r.kOrange+6, 0.2)
    ...
    #make njet plot##############################################################################################################################################################################
    nj_1_SF_mc=treeMC.getTH1F(lumi,"M_n20-60_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll20_60]),'', labelnjet, "1", kf) 
    nj_1_SF_da=treeDA.getTH1F(lumi,"D_n20-60_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll20_60]),'', labelnjet, "1", kf)
    nj_1_OF_mc=treeMC.getTH1F(lumi,"M_n20-60_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll20_60]),'', labelnjet, "1", kf)
    nj_1_OF_da=treeDA.getTH1F(lumi,"D_n20-60_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll20_60]),'', labelnjet, "1", kf)
    nj_2_SF_mc=treeMC.getTH1F(lumi,"M_n60-86_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll60_86]),'', labelnjet, "1", kf)
    nj_2_SF_da=treeDA.getTH1F(lumi,"D_n60-86_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll60_86]),'', labelnjet, "1", kf)
    nj_2_OF_mc=treeMC.getTH1F(lumi,"M_n60-86_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll60_86]),'', labelnjet, "1", kf)
    nj_2_OF_da=treeDA.getTH1F(lumi,"D_n60-86_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll60_86]),'', labelnjet, "1", kf)
    nj_z_SF_mc=treeMC.getTH1F(lumi,"M_n86-96_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll86_96]),'', labelnjet, "1", kf)
    nj_z_SF_da=treeDA.getTH1F(lumi,"D_n86-96_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll86_96]),'', labelnjet, "1", kf)
    nj_z_OF_mc=treeMC.getTH1F(lumi,"M_n86-96_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll86_96]),'', labelnjet, "1", kf)
    nj_z_OF_da=treeDA.getTH1F(lumi,"D_n86-96_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll86_96]),'', labelnjet, "1", kf)
    nj_3_SF_mc=treeMC.getTH1F(lumi,"M_n96-150_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll96_150]),'',labelnjet, "1", kf)
    nj_3_SF_da=treeDA.getTH1F(lumi,"D_n96-150_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll96_150]),'',labelnjet, "1", kf)
    nj_3_OF_mc=treeMC.getTH1F(lumi,"M_n96-150_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll96_150]),'',labelnjet, "1", kf)
    nj_3_OF_da=treeDA.getTH1F(lumi,"D_n96-150_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll96_150]),'',labelnjet, "1", kf)
    nj_4_SF_mc=treeMC.getTH1F(lumi,"M_n150-200_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll150_200]),'',labelnjet, "1", kf)
    nj_4_SF_da=treeDA.getTH1F(lumi,"D_n150-200_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll150_200]),'',labelnjet, "1", kf)
    nj_4_OF_mc=treeMC.getTH1F(lumi,"M_n150-200_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll150_200]),'',labelnjet, "1", kf)
    nj_4_OF_da=treeDA.getTH1F(lumi,"D_n150-200_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll150_200]),'',labelnjet, "1", kf)
    nj_5_SF_mc=treeMC.getTH1F(lumi,"M_n200-300_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll200_300]),'',labelnjet, "1", kf)
    nj_5_SF_da=treeDA.getTH1F(lumi,"D_n200-300_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll200_300]),'',labelnjet, "1", kf)
    nj_5_OF_mc=treeMC.getTH1F(lumi,"M_n200-300_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll200_300]),'',labelnjet, "1", kf)
    nj_5_OF_da=treeDA.getTH1F(lumi,"D_n200-300_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll200_300]),'',labelnjet, "1", kf)
    nj_6_SF_mc=treeMC.getTH1F(lumi,"M_n300-400_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll300_400]),'',labelnjet, "1", kf)
    nj_6_SF_da=treeDA.getTH1F(lumi,"D_n300-400_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll300_400]),'',labelnjet, "1", kf)
    nj_6_OF_mc=treeMC.getTH1F(lumi,"M_n300-400_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll300_400]),'',labelnjet, "1", kf)
    nj_6_OF_da=treeDA.getTH1F(lumi,"D_n300-400_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll300_400]),'',labelnjet, "1", kf)
    nj_7_SF_mc=treeMC.getTH1F(lumi,"M_n400_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll400]),'',labelnjet, "1", kf)
    nj_7_SF_da=treeDA.getTH1F(lumi,"D_n400_SF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll400]),'',labelnjet, "1", kf)
    nj_7_OF_mc=treeMC.getTH1F(lumi,"M_n400_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll400]),'',labelnjet, "1", kf)
    nj_7_OF_da=treeDA.getTH1F(lumi,"D_n400_OF","nJetSel_Edge",njbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF, cuts.DYControlRegionNoMllNoNJet,cuts.METl100,cuts.mll400]),'',labelnjet, "1", kf)
    ...
    nj_rinout_20_60_mc = make_rinout_histo(nj_1_corrected_mc, nj_z_corrected_mc, 0., 0.4 )
    nj_rinout_20_60_da = make_rinout_histo(nj_1_corrected_da, nj_z_corrected_da, 0., 0.4 )  
    nj_rinout_60_86_mc = make_rinout_histo(nj_2_corrected_mc, nj_z_corrected_mc, 0., 0.8 )
    nj_rinout_60_86_da = make_rinout_histo(nj_2_corrected_da, nj_z_corrected_da, 0., 0.8 )  
    nj_rinout_96_150_mc = make_rinout_histo(nj_3_corrected_mc, nj_z_corrected_mc, 0., 1.0 ) 
    nj_rinout_96_150_da = make_rinout_histo(nj_3_corrected_da, nj_z_corrected_da, 0., 1.0 )
    nj_rinout_150_200_mc = make_rinout_histo(nj_4_corrected_mc, nj_z_corrected_mc, 0., 0.3 )  
    nj_rinout_150_200_da = make_rinout_histo(nj_4_corrected_da, nj_z_corrected_da, 0., 0.3 )
    nj_rinout_200_300_mc = make_rinout_histo(nj_5_corrected_mc, nj_z_corrected_mc, 0., 0.1 ) 
    nj_rinout_200_300_da = make_rinout_histo(nj_5_corrected_da, nj_z_corrected_da, 0., 0.1 )
    ...
    plot_nj_rinout_20_60.addBand(nj_rinout_20_60_mc.GetXaxis().GetXmin(), rinout_20_60_da[0]*0.5, nj_rinout_20_60_mc.GetXaxis().GetXmax(), rinout_20_60_da[0]*1.5, r.kOrange+6, 0.2)
    ...
    plot_nj_rinout_60_86.addBand(nj_rinout_60_86_mc.GetXaxis().GetXmin(), rinout_60_86_da[0]*0.5, nj_rinout_60_86_mc.GetXaxis().GetXmax(), rinout_60_86_da[0]*1.5, r.kOrange+6, 0.2)
    ...
    plot_nj_rinout_96_150.addBand(nj_rinout_96_150_mc.GetXaxis().GetXmin(), rinout_96_150_da[0]*0.5, nj_rinout_96_150_mc.GetXaxis().GetXmax(), rinout_96_150_da[0]*1.5, r.kOrange+6, 0.2)
    ...
    plot_nj_rinout_150_200.addBand(nj_rinout_150_200_mc.GetXaxis().GetXmin(), rinout_150_200_da[0]*0.5, nj_rinout_150_200_mc.GetXaxis().GetXmax(), rinout_150_200_da[0]*1.5, r.kOrange+6, 0.2)
    ...
    plot_nj_rinout_200_300.addBand(nj_rinout_200_300_mc.GetXaxis().GetXmin(), rinout_200_300_da[0]*0.5, nj_rinout_200_300_mc.GetXaxis().GetXmax(), rinout_200_300_da[0]*1.5, r.kOrange+6, 0.2)
    ...
    plot_nj_rinout_300_400.addBand(nj_rinout_300_400_mc.GetXaxis().GetXmin(), rinout_300_400_da[0]*0.5, nj_rinout_300_400_mc.GetXaxis().GetXmax(), rinout_300_400_da[0]*1.5, r.kOrange+6, 0.2)
    ...
    plot_nj_rinout_400.addBand(nj_rinout_400_mc.GetXaxis().GetXmin(), rinout_400_da[0]*0.5, nj_rinout_400_mc.GetXaxis().GetXmax(), rinout_400_da[0]*1.5, r.kOrange+6, 0.2)
