...
def runAnalysis(lumi, treeDA, treeMC, cuts, specialcut, tag, save, ingredientsFile):
    ...
    if makeNicePlot:
       #make the nice finely binned plots for the presentation
        mll_SF_inclusive_mc = treeMC.getTH1F(lumi,"MC_inclusive_mll_SF","lepsMll_Edge",inclusivebins,1,1,cuts.AddList([cuts.mT2_80, cuts.goodLepton, cuts.SF, cuts.DYControlRegionNoMll]), '', labelx)
        mll_OF_inclusive_mc = treeMC.getTH1F(lumi,"MC_inclusive_mll_OF","lepsMll_Edge",inclusivebins,1,1,cuts.AddList([cuts.mT2_80, cuts.goodLepton, cuts.OF, cuts.DYControlRegionNoMll]), '', labelx)
        mll_SF_inclusive_da = treeDA.getTH1F(lumi,"DA_inclusive_mll_SF","lepsMll_Edge",inclusivebins,1,1,cuts.AddList([cuts.mT2_80, cuts.goodLepton, cuts.SF, cuts.DYControlRegionNoMll]),'', labelx)
        mll_OF_inclusive_da = treeDA.getTH1F(lumi,"DA_inclusive_mll_OF","lepsMll_Edge",inclusivebins,1,1,cuts.AddList([cuts.mT2_80, cuts.goodLepton, cuts.OF, cuts.DYControlRegionNoMll]),'', labelx)
    ...
    met_1_SF_da= treeDA.getTH1F(lumi,"DA_20-60SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll20_60]),'', labelmet)
    ...
    met_1_OF_da= treeDA.getTH1F(lumi,"DA_20-60OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll20_60]),'', labelmet)
    ...
    met_2_SF_da= treeDA.getTH1F(lumi,"DA_60-86SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll60_86]),'', labelmet)
    ...
    met_2_OF_da= treeDA.getTH1F(lumi,"DA_60-86OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll60_86]),'', labelmet)
    ...
    met_z_SF_da= treeDA.getTH1F(lumi,"DA_86-96SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll86_96]),'', labelmet)
    ...
    met_z_OF_da= treeDA.getTH1F(lumi,"DA_86-96OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll86_96]),'', labelmet)
    ...
    met_3_SF_da= treeDA.getTH1F(lumi,"DA_96-150SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll96_150]),'', labelmet)
    ...
    met_3_OF_da= treeDA.getTH1F(lumi,"DA_96-150OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll96_150]),'', labelmet)
    ...
    met_4_SF_da= treeDA.getTH1F(lumi,"DA_150-200SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll150_200]),'',labelmet)
    ...
    met_4_OF_da= treeDA.getTH1F(lumi,"DA_150-200OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll150_200]),'',labelmet)
    ...
    met_5_SF_da= treeDA.getTH1F(lumi,"DA_200-300SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll200_300]),'',labelmet)
    ...
    met_5_OF_da= treeDA.getTH1F(lumi,"DA_200-300OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll200_300]),'',labelmet)
    ...
    met_6_SF_da= treeDA.getTH1F(lumi,"DA_300-400SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll300_400]),'',labelmet)
    ...
    met_6_OF_da= treeDA.getTH1F(lumi,"DA_300-400OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll300_400]),'',labelmet)
    ...
    met_7_SF_da= treeDA.getTH1F(lumi,"DA_400_SF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.SF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll400]),'', labelmet)
    ...
    met_7_OF_da= treeDA.getTH1F(lumi,"DA_400_OF","met_Edge",metbins,1,1,cuts.AddList([cuts.mT2_80,cuts.OF,cuts.METl100, cuts.DYControlRegionNoMllNoMET,cuts.mll400]),'', labelmet)
