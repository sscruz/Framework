...
if __name__ == "__main__":
   ...
   # plot_3l_met_ZmassCut_WmT = makePlot(lumi, lumi_str, treeDA, treeMC, tree3l, treeBKG, "met_Edge", "met_3l_ZmassCut_WmT40", 30,  50, 200, cuts.AddList([cuts.goodLepton, cuts.region3lSlepton, "mZ1_Edge < 101 && mZ1_Edge > 81 && WmT_Edge > 50"]), cuts, "p_{T}^{miss} [GeV]", 0, True)
    ...
    #plot_3l_WmT_ZmassLoose = makePlot(lumi, lumi_str, treeDA, treeMC, tree3l, treeBKG, "WmT_Edge", "WmT_3l_ZmassLoose", 40,  0, 200, cuts.AddList([cuts.goodLepton, cuts.region3lSlepton, "mZ1_Edge < 106     && mZ1_Edge > 76"]), cuts, "M_{T} (w/ W lep) [GeV]", 0, True)
    ...
    #plot_3l_WmT_Zmass = makePlot(lumi, lumi_str, treeDA, treeMC, tree3l, treeBKG, "WmT_Edge", "WmT_3l_Zmass", 40,  0, 200, cuts.AddList([cuts.goodLepton, cuts.region3lSlepton, "mZ1_Edge < 101     && mZ1_Edge > 81"]), cuts, "M_{T} (w/ W lep) [GeV]", 0, True)
