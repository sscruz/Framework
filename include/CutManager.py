...
class CutManager:
   ...
   def __init__(self):
      ...
      self.trigMM17 = "( HLT_DoubleMu_Edge ==1 )"
      self.trigEE17 = "( HLT_DoubleEl_Edge ==1 )"
      self.trigEM17 = "( HLT_MuEG_Edge ==1 )"
